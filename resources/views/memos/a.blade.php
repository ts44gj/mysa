    ...
    <div class="container">
                        ...
                        <div class="card mt-3">
                            <div class="card-body d-flex flex-row">
                                ...
                                @if (Auth::id() === $memo->user_id)
                                    ...
                                    <!-- modal -->
                                    <div id="modal-delete-{{ $memo->id }}" class="modal fade" tabindex="-1"
                                        role="dialog">
        ...
        <div class="card mt-3">
            <div class="card-body d-flex flex-row">
                ...
                <div class="card">
                    <div class="card-header">memo内容</div>
                    <div class="card-body">
                        <h5 class="card-title">{{ $memo->title }}</h5>
                        <p class="card-text">{{ $memo->body }}</p>
                        @foreach ($memo->tags as $tag)
                            @if ($loop->first)
                                <div class="card-body pt-0 pb-4 pl-3"></div>
                                <div class="card-text line-height"></div>
                            @endif
